...
const reviews = [
  ...
  const services = [
    {
      id: 1,
      service: "Printing",
      description: "d eedbjwbfnrk43r4brk43rv3rhj...............3uhhhhhhhhhhhriiiiiiii ewnoEF4BUYVHHHHHH3YUIJBfgdjfk/gktr;go4ijjew.vvhbwjklj3r4;t5/gj3nkr",
      pic:
        "https://res.cloudinary.com/diqqf3eq2/image/upload/v1586883334/person-1_rfzshl.jpg",
    },
    {
      id: 2,
      service: "Web Design",
      description: "e dwnefb jrbfhjvdhkwqbd;lmvpojfu2bwe,nl jondsjlf ,rvb mkjagf Ns rvb efksg2fnfkdnvkfbnw fefnkbrwfn rgndflgbwed eg frefkhe rr,ewgb;rbl   dwn jfn;",
      pic:
        "https://res.cloudinary.com/diqqf3eq2/image/upload/v1586883409/person-2_np9x5l.jpg",
    },
    {
      ...
      description: ", d ejwfwrf kwrfnjkhrfkewnf nmvbrjkbgfp;42jejffduqfekjwrhgarnglkwbffwbfkrengmbgkemgglengrbgkerngkjrfbd,nejgbrgekegjej f jerbfewbf rg lgj4vjwnrihwv",
      pic:
        "https://res.cloudinary.com/diqqf3eq2/image/upload/v1586883417/person-3_ipa0mj.jpg",
    },
    {
  ...
  const pic = document.getElementById("service-img");
